...
template __host__ void __cdecl __host__matrix_plus<DATATYPE>(dim3 blocks, dim3 threads, MATRIX<DATATYPE> *a, MATRIX<DATATYPE> *b, MEMORY src, MEMORY dest, MEMORY cache);
